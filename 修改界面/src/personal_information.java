...
public class personal_information {
    ...
    //头像
    public static ImageIcon headImage = new ImageIcon("./head_portrait\\head1(4).png");
    public static JButton headPicture = new JButton(headImage);
    ...
    public personal_information()
    {
        ...
        headPicture.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Head_choose hc = new Head_choose();
            }
        });
    }
}
