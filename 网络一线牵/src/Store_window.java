...
public class Store_window {
    ...
    static JButton buy1 = new JButton("大白鲨:15源石");
    static JButton buy2 = new JButton("往昔回忆:15源石");
    static JButton buy3 = new JButton("洋流:30源石");
    static JButton buy4 = new JButton("Futari Dake No Hanabi:30源石");
    ...
    public Store_window()
    {
        ...
        //
        //创建商品项目1
        ImageIcon item_image1 = new ImageIcon("./Course\\gif1.gif");
...
//以下为第三页
        ...
        buy1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(JOptionPane.OK_OPTION== option){
                    ...
                    n = n - 15;
                    money1.setText("你目前拥有" + n + "源石");
                    money2.setText("你目前拥有" + n + "源石");
                    money3.setText("你目前拥有" + n + "源石");
                    buy1.setText("商品4:已拥有(点击皮肤设置)");
        ...
        item1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ImageIcon image = new ImageIcon("./Course\\gif1.gif");
                int option = JOptionPane.showConfirmDialog(f, "是否要设置该皮肤？");
                if(JOptionPane.OK_OPTION == option) {
                    JOptionPane.showMessageDialog(f, "设置成功！");
                    ChatFrame.text_background.setIcon(image);
                }
            }
        });
        ...
        item2.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ImageIcon image = new ImageIcon("./Course\\item2(2).png");
                int option = JOptionPane.showConfirmDialog(f, "是否要设置该皮肤？");
                if(JOptionPane.OK_OPTION == option) {
                    JOptionPane.showMessageDialog(f, "设置成功！");
                    ChatFrame.text_background.setIcon(image);
        ...
        item3.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ImageIcon image = new ImageIcon("./Course\\item3(2).png");
                int option = JOptionPane.showConfirmDialog(f, "是否要设置该皮肤？");
                if(JOptionPane.OK_OPTION == option) {
                    JOptionPane.showMessageDialog(f, "设置成功！");
                    ChatFrame.text_background.setIcon(image);
